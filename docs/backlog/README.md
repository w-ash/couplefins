...
| v1.8.1 | Chat read parity — 8 new read tools covering every human-visible query surface | Planned ([spec](v1.8.1-chat-read-parity.md)) | M |
| v1.8.2 | Chat write parity — 12 new mutation tools, all two-phase confirmed | Planned ([spec](v1.8.2-chat-write-parity.md)) | L |
